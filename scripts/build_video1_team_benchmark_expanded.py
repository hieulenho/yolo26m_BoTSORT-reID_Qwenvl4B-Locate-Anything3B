...
def main() -> None:
    ...
    generated_at = now()
    manifest_path = OUTPUT_DIR / "benchmark_manifest_expanded.json"
    manifest = {
        ...
        "created_at": existing_created_at(manifest_path, generated_at),
        "sequences": [
            {
                "sequence_name": SEQUENCE_NAME,
                "split": "dev",
    ...
    for pipeline, variant_id, variant_name, pipeline_type in [
        ...
        prediction_path = OUTPUT_DIR / suffix
        prediction = {
            "variant_id": variant_id,
            "variant_name": variant_name,
            "benchmark_name": BENCHMARK_NAME,
            "pipeline_type": pipeline_type,
            "created_at": existing_created_at(prediction_path, generated_at),
            "track_predictions": [
